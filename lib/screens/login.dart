...
import 'package:scannerqrcode/screens/signup.dart';
              ...
              children: [
                ...
                Text(
                  ...
                  style: GoogleFonts.pacifico(
                      ...
                      fontSize: 50,
                      color: Color.fromARGB(150, 240, 243, 33)),
                ),
                SizedBox(
                  height: 25,
                ),
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        errorBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(16),
                            borderSide: BorderSide(
                                color: Color.fromARGB(188, 244, 177, 54))),
                        focusedErrorBorder: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(16),
                            borderSide: BorderSide(
                                color: Color.fromARGB(218, 244, 184, 54)))),
                  ),
                ),
                Padding(
                  padding: const EdgeInsets.all(16.0),
